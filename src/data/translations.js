...
Our goal is to highlight these sports and the locations where they can be experienced across Egypt.`,
    ...
    contact: {
      ...
      popularSports: 'الرياضات الأكثر شعبية',
      chartVisualization: 'سيظهر تصور الرسم البياني هنا',
      months: {
        jan: 'يناير',
        feb: 'فبراير',
        mar: 'مارس',
      ...
      sportsLabels: {
        paramotor: 'الطيران الشراعي بالمحرك',
        diving: 'الغوص',
        kitesurfing: 'التزلج الشراعي',
        hiking: "الهايكنج",
        sandboarding: 'التزلج على الرمال',
      },
    },
    aboutPage: {
    ...
    bookingConfirmation: {
      ...
      bookedItem: 'Booked Item',
      bookingDate: 'Date',
      nextStepsTitle: 'What\'s Next?',
      nextStepsContent1: 'You will receive a detailed itinerary and payment instructions shortly via email. Please check your inbox and spam folder.',
      nextStepsContent2: 'For any immediate questions, feel free to contact our support team.',
...
`,
    ...
    bookingConfirmation: {
      ...
      bookedItem: 'العنصر المحجوز',
      bookingDate: 'التاريخ',
      nextStepsTitle: 'ماذا بعد؟',
      nextStepsContent1: 'ستتلقى تفاصيل خط سير الرحلة وتعليمات الدفع قريبًا عبر البريد الإلكتروني. يرجى التحقق من صندوق الوارد ومجلد البريد العشوائي.',
      nextStepsContent2: 'لأية استفسارات فورية، لا تتردد في الاتصال بفريق الدعم لدينا.',
